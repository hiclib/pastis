...
def pastis_poisson(lengths, ploidy, maternal_maternal=None,
                   paternal_paternal=None, maternal_paternal=None,
                   maternal_unknown=None, paternal_unknown=None,
                   unknown_unknown=None, haploid=None, counts=None, outdir='',
                   chromosomes=None, chrom_subset=None, alpha=None, seed=0,
                   normalize=True, filter_threshold=0.04, alpha_init=-3.,
                   max_alpha_loop=20, beta=None, multiscale_rounds=1,
                   use_multiscale_variance=True, max_iter=30000,
                   factr=10000000., pgtol=1e-05, alpha_factr=1000000000000.,
                   bcc_lambda=0., hsc_lambda=0., hsc_r=None, hsc_min_beads=5,
                   mhs_lambda=0., mhs_k=None, struct_draft_fullres=None,
    ...
    Raises
    ------
    ValueError : if no counts data files (cooler, hiclib, numpy) are specified
    """
    if (maternal_maternal==None & paternal_paternal==None &
        maternal_paternal==None & maternal_unknown==None & paternal_unknown==None &
        unknown_unknown==None & haploid==None & counts==None):    
        raise ValueError("Specify data files for the counts data")
    ...
    counts, lengths_subset, chrom_subset, lengths_full, chrom_full, struct_true = load_data(
        lengths_full=lengths_full, ploidy=ploidy,
        maternal_maternal=maternal_maternal,
        paternal_paternal=paternal_paternal,
        maternal_paternal=maternal_paternal, maternal_unknown=maternal_unknown,
        paternal_unknown=paternal_unknown, unknown_unknown=unknown_unknown,
        haploid=haploid, counts=counts, chrom_full=chrom_full,
        chrom_subset=chrom_subset, exclude_zeros=exclude_zeros,
