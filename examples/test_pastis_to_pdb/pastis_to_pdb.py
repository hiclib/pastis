...
def main():
    ...
    between the coordinates in the input file. In the case where we are
    interpolating a diploid structure (interpolate diploid case), either
    lengths or a .bed file must be provided.
    ...
    ploidy: int
        ...
        If 0, considers the structure to be diploid.
    lengths: int int
